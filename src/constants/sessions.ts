...
export const defaultShouldersAndTricepsSession: WorkoutSessions = {
  ...
  excercises: [
    ...
    { ...SHOULDERS_EXCERCISES["Dumbells Bent Over Reverse Fly"], setsCount: 2, repsCount: 10 },
    { ...SHOULDERS_EXCERCISES["Dumbells Shrugs"], setsCount: 3, repsCount: 20 },
    {
      name: "Triceps Press",
      bodyPart: Shoulders,
      isSuperSet: true,
    ...
    {
      name: "Triceps Pushdown & Extension Combined",
      bodyPart: Shoulders,
      isSuperSet: true,
      setsCount: 3,
      repsCount: 10,
